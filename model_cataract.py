...
INPUT_SIZE = (100, 100)
WEIGHTS_PATH = 'efficientnet_cataract.h5'
...
def pred_cataract_disease(img_path: str) -> tuple[str, float]:
    """
    Predict the eye condition from the given image path.
    ...
    print(f"[Cataract] Predicted: {predicted_label} | Confidence: {confidence:.2%}")
